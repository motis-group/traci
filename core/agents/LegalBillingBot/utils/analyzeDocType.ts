...
import openai, { ChatCompletion } from "../integrations/openaiClient";
...
You are a world class legal expert, please help me review the doc and help me categorize its type (e.g. privacy policy, terms of service, etc.).`;
